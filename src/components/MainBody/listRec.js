...
export default class ListRec extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      index: 0,
        ...
        <ul className="entrySubmList">
          {items.map(function (item, i) {
            return (
              <li ref={i}>
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/field-scan.appspot.com/o/Annotation%202020-05-27%20224900.png?alt=media&token=eee1cf2d-f55d-4bd0-869d-56fbdc3c13c4"
                  alt=""
                />
              </li>
            );
